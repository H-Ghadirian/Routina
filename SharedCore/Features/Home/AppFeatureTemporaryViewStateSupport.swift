...
enum AppFeatureTemporaryViewStateSupport {
    ...
    static func makeTemporaryViewState<State: AppFeatureTemporaryViewState>(
        ...
        return TemporaryViewState(
            ...
            homeSelectedTimelinePressureFilter: existing.homeSelectedTimelinePressureFilter,
            homeSelectedTimelineThinkingNeededFilter: existing.homeSelectedTimelineThinkingNeededFilter,
            homeSelectedTimelineEstimationFilter: existing.homeSelectedTimelineEstimationFilter,
