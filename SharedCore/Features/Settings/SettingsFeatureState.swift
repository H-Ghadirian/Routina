...
struct SettingsDiagnosticsState: Equatable {
    ...
    var signedCloudKitEnvironmentDescription: String = "Unavailable"
...
struct SettingsAppearanceState: Equatable {
    ...
    var timelineRowVisibility: HomeTimelineRowVisibility = .defaultValue
    ...
    var showsDoneCountInToolbar: Bool = false
