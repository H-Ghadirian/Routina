...
private struct DayPlanHeaderView: View {
    ...
    private var macHeaderExpandedControlsWidthProbe: some View {
        ...
        .background {
            GeometryReader { proxy in
                Color.clear.preference(
                    key: DayPlanHeaderFullRegularDateControlsWidthPreferenceKey.self,
                    value: proxy.size.width
                )
            }
        }
...
private struct DayPlanTagFocusSidebar: View {
    @Environment(\.modelContext) private var modelContext
    ...
    private func saveChanges() {
        guard DayPlanFocusSessionPlannerSync.updateCompletedTagFocusSession(
            session,
            startedAt: startedAt,
            durationMinutes: durationMinutes,
            calendar: calendar,
