...
struct AddRoutineTaskFormModelFactory {
    ...
    func make() -> TaskFormModel {
        TaskFormModel(
            ...
            selectedEventIDs: store.organization.eventIDs,
            availableEvents: store.organization.availableEvents,
            onToggleEventSelection: { store.send(.toggleEventSelection($0)) },
            ...
            advancedRecurrenceRule: binding(
                get: { store.schedule.advancedRecurrenceRule },
                send: AddRoutineFeature.Action.advancedRecurrenceRuleChanged
            ),
            ...
            recurrenceTimeRangeRole: binding(
                get: { store.schedule.recurrenceTimeRangeRole },
                send: AddRoutineFeature.Action.recurrenceTimeRangeRoleChanged
            ),
