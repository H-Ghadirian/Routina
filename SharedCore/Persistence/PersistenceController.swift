    ...
    init(inMemory: Bool = false) {
        ...
        do {
            ...
            container = try ModelContainer(
                ...
                AwaySession.self,
                SleepSession.self,
                PlaceCheckInSession.self,
                RoutineEvent.self,
                EmotionLog.self,
                RoutineNote.self,
                RoutineNoteAttachment.self,
                RoutinePlace.self,
                RoutineAttachment.self,
                RoutinaDeviceSession.self,
                RoutinaDeviceActionLog.self,
            ...
            case .retryPrimaryPersistentStore:
                do {
                    ...
                    NSLog(
                        "Retry with the same persistent-store configuration failed: \(error.localizedDescription). Falling back to local-only store."
                    )
                }
