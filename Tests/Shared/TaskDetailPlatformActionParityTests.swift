...
struct TaskDetailPlatformActionParityTests {
    ...
    func iosTaskDetailsGroupMaintenanceActionsInNavigationOverflow() throws {
        ...
        #expect(toolbarSource.contains("if showsCollapsedTaskTitle {"))
        #expect(toolbarSource.contains("Menu {"))
        #expect(toolbarSource.contains("ControlGroup {"))
        #expect(toolbarSource.contains("Label(\"Edit task details\", systemImage: \"square.and.pencil\")"))
        #expect(toolbarSource.contains(".accessibilityLabel(\"Edit task details\")"))
        #expect(toolbarSource.contains(".accessibilityIdentifier(\"taskDetail.collapsedEditMenu\")"))
        #expect(toolbarSource.contains(".accessibilityIdentifier(\"taskDetail.collapsedTitle\")"))
        #expect(toolbarSource.contains("Label(\"Edit task\", systemImage: \"square.and.pencil\")"))
        #expect(toolbarSource.contains("Label(\"Add a detail\", systemImage: \"chevron.down\")"))
    ...
    func taskDetailGroupsAddDetailWithEditWithoutUsingMaintenanceOverflow() throws {
        ...
        #expect(iosToolbarSource.contains("if showsCollapsedTaskTitle {"))
        #expect(iosToolbarSource.contains("Menu {"))
        #expect(iosToolbarSource.contains("ControlGroup {"))
        #expect(iosToolbarSource.contains("Label(\"Edit task details\", systemImage: \"square.and.pencil\")"))
