...
struct TaskRelationshipReviewFeatureTests {
    ...
    func macMenuOpensDedicatedReducerOwnedReviewWindow() throws {
        ...
        #expect(view.contains("Text(\"Possible relationships\")"))
        #expect(view.contains("DisclosureGroup(isExpanded: $isOtherTasksExpanded)"))
        #expect(view.contains("Text(\"Other tasks\")"))
        #expect(view.contains("SidebarPresentation"))
