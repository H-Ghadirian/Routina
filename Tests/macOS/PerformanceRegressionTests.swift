...
final class PerformanceRegressionTests: XCTestCase {
    ...
    func testMacHomeFocusToolbarUsesSingleTimerSlot() throws {
        ...
        XCTAssertTrue(source.contains("static let compactWidth: CGFloat = 460"))
        XCTAssertTrue(source.contains("static let focusedWidth: CGFloat = 720"))
