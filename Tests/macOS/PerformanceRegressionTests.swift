...
final class PerformanceRegressionTests: XCTestCase {
    ...
    func testMacToolbarSearchTemporarilyRevealsSidebarAndRestoresCollapseState() throws {
        ...
        XCTAssertTrue(taskListSource.contains("private enum MacTaskSourceListScrollAnchor: Hashable"))
        XCTAssertTrue(taskListSource.contains("private enum MacTaskSourceListScrollContainerIdentity: Hashable"))
        XCTAssertTrue(taskListSource.contains("private struct MacTaskSourceListScrollResetView: NSViewRepresentable"))
        ...
        XCTAssertTrue(taskListSource.contains("proxy.scrollTo(MacTaskSourceListScrollAnchor.top, anchor: .top)"))
        XCTAssertTrue(taskListSource.contains("scrollView.documentView?.layoutSubtreeIfNeeded()"))
        XCTAssertTrue(taskListSource.contains("scrollView.reflectScrolledClipView(clipView)"))
