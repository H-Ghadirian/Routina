...
struct AppFeatureTests {
    ...
    func missingPressureTaskDetailsRequest_opensTheTaskFromHome() async {
        ...
        await store.send(
            .missingPressureData(.delegate(.taskDetailsRequested(taskID)))
        ) {
            $0.hasRestoredTemporaryViewState = true
            $0.selectedTab = .home
        }
    ...
    func missingThinkingNeededTaskDetailsRequest_opensTheTaskFromHome() async {
        ...
        await store.send(
            .missingThinkingNeededData(.delegate(.taskDetailsRequested(taskID)))
        ) {
            $0.hasRestoredTemporaryViewState = true
            $0.selectedTab = .home
        }
    ...
    func missingTimeEstimateTaskDetailsRequest_opensTheTaskFromHome() async {
        ...
        await store.send(
            .missingEstimatedDurationData(.delegate(.taskDetailsRequested(taskID)))
        ) {
            $0.hasRestoredTemporaryViewState = true
            $0.selectedTab = .home
        }
