...
private extension HomeFeature.RoutineDisplay {
    init(core: HomeRoutineDisplayCore) {
        self.init(
            ...
            customTaskSectionID: core.customTaskSectionID,
            priority: core.priority,
            importance: core.importance,
            urgency: core.urgency,
            pressure: core.pressure,
            thinkingNeeded: core.thinkingNeeded,
            currentTaskLadderImportanceOverride: core.currentTaskLadderImportance,
            currentTaskLadderUrgencyOverride: core.currentTaskLadderUrgency,
            currentTaskLadderPressureOverride: core.currentTaskLadderPressure,
