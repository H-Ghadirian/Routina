...
- Simple recurrence remains the default and keeps the existing Interval / Calendar controls. Calendar repeats offer weekday and month-day choices, and editing a calendar routine preserves every selected weekday or monthly date. Interval repeats own Simple's single daily-repeat path.
