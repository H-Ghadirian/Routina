...
- Mac Task Details and Edit Task distinguish `Create New Task`, which opens a new task prelinked to the current task, from `Link a Task`, which opens the existing-task relationship picker.
