...
- Task Details hides neutral Priority metadata and History by default. Full details offers both through Add More Details; saved non-default priority metadata remains visible automatically, while adding History stores a per-task visibility preference that survives copying and backup/restore.
