...
Routina aligns its public semantic version and Apple build number across its iOS, iPadOS, watchOS, macOS, and bundled extension targets. The release notes remain separate because the available UI, features, changes, fixes, and known issues can differ by platform. See [Decision 0416](../decisions/0416-use-semantic-release-versions.md) for version numbering and [Decision 0519](../decisions/0519-maintain-platform-versioned-release-notes.md) for this documentation convention.
