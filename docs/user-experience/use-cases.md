...
**Evidence:** User-described need and interaction preferences on 2026-08-21, including direct feedback that duplicate Details sections and separated link/image content were confusing, and that Jira's scalable relationship vocabulary was the intended reference for linked-task composition.
