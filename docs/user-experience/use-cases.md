...
**iOS global access:** Choosing Focus from New either opens the active timer's controls or presents one task/tag and duration picker. Starting Focus should not require finding the task in the current Home filter or entering Task Details first.
