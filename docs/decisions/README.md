...
- **[0198](0198-separate-task-date-and-time-availability.md) refines [0197](0197-separate-todo-date-and-time-availability.md) and [0178](0178-make-recurrence-availability-independent.md) for task availability:** Todo and routine forms share separate date and time availability axes; routine date availability filters recurrence occurrences without replacing repeat cadence.
...
| [0198](0198-separate-task-date-and-time-availability.md) | Separate Task Date and Time Availability | Accepted | 2026-06-10 |
