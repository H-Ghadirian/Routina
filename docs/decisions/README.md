...
- **Focus achievements:** Stats includes all-time focus achievement badges derived from completed focus sessions. Badges recognize total focus time, five-minute blocks, single-session depth, strong focus days, streaks, rolling-week consistency, and returning after seven quiet days. Locked badges remain visible with progress.
...
| [0122](0122-show-focus-achievement-badges.md) | Show Focus Achievement Badges | Accepted | 2026-05-31 |
