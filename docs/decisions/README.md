...
- **Planner all-day calendar events:** Imported all-day calendar events render in a dedicated all-day lane above the timed planner grid. Calendar imports preserve all-day start/end metadata in hidden task-note markers, and legacy date-only calendar imports render as one-day all-day events.
