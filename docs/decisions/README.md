...
- **Progressive task forms:** Task creation and editing show identity and scheduling first, keep populated optional sections visible, and offer empty optional fields as individual Add Details buttons that reveal only the chosen section. Task detail hides empty optional sections and exposes compact Add More actions for comments, linked tasks, and richer details.
