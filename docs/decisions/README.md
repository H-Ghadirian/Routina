...
- **[0173](0173-use-ios-new-tab-long-press-menu.md) supersedes part of [0071](0071-move-ios-task-add-to-tab-bar.md) and [0073](0073-open-ios-home-actions-horizontally.md) for compact iOS capture actions:** The bottom-bar `Task` action is now `New`, tap still opens smart task creation, and long-press opens Event, Emotion, Note, Goal, Task, Check In, Away, and Going to sleep above the New tab while Home keeps Home-specific controls such as filters.
...
| [0173](0173-use-ios-new-tab-long-press-menu.md) | Use iOS New Tab Long-Press Menu | Accepted | 2026-06-07 |
