...
- **Focus timeline entries:** Timeline shows task, unassigned, and board focus sessions as first-class Focus entries at their start time. Active, paused, completed, and abandoned task focus sessions can appear immediately as Timeline evidence; board focus sessions do the same through sprint focus history. Focus entries are visible in All and Focus filters, can inherit linked-task tags and importance/urgency, and remain separate from media, done, missed, and canceled outcome filters.
...
| [0126](0126-show-focus-sessions-in-timeline.md) | Show Focus Sessions in Timeline | Accepted | 2026-06-01 |
