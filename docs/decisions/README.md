...
- **[0207](0207-show-timeline-oldest-to-newest.md) refines [0206](0206-capture-status-from-mac-sidebar.md) for chat-style timeline order:** Timeline renders oldest-to-newest, list surfaces default to the bottom, and split-view timeline selection falls back to the latest visible entry.
