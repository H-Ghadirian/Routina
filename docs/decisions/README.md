...
- **[0182](0182-show-todo-all-day-as-availability.md) refines [0179](0179-make-all-day-an-availability-choice.md) for todo form controls:** Todo forms show Availability below the Routine/Todo picker with only `Any time` and `All-day`; all-day remains independent from deadline, while exact-time/window availability stays routine-only until modeled for todos.
