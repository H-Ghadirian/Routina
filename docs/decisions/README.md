...
- **Stats achievements:** Stats includes an Achievements dashboard scope and all-time achievement badges derived from completed focus sessions, completed sleep sessions, finished Away sessions, planned-duration Away completions, and completed `RoutineLog` history. Badges preserve the focus milestones for total focus time, five-minute blocks, single-session depth, strong focus days, streaks, rolling-week consistency, and returning after quiet days while adding sleep, away, and done milestones. Locked badges remain visible with progress. The Achievements section can be viewed by All, Focus, Sleep, Away, and Done categories, badges are separated into In Progress and Achieved groups, and Done badges include a longer ladder for total completions, high-output days, streaks, and full-week consistency.
