...
- [0099](0099-block-selected-mac-apps-during-focus.md) and [0159](0159-support-entered-website-blocking-on-ios.md) defer native macOS website blocking until there is a supported entitlement-backed implementation. Should native Mac website blocking stay deferred, or become a dedicated platform investigation?
