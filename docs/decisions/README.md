...
- **[0165](0165-suggest-backup-before-cloud-data-reset.md) refines [0164](0164-require-password-for-cloud-data-reset.md) for cloud data reset recovery:** The reset confirmation presents backup first, with a direct backup export action and visible backup status before the deletion password section.
- **[0164](0164-require-password-for-cloud-data-reset.md) strengthens destructive data reset behavior:** iCloud data reset requires a one-time deletion password to be created and re-entered before the reducer can begin deleting data.
...
| [0164](0164-require-password-for-cloud-data-reset.md) | Require a Password for Cloud Data Reset | Accepted | 2026-06-06 |
