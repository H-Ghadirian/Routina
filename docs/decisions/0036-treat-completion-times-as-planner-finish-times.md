...
When completed activities are close enough to overlap, the planner arranges them backwards from the latest completion so they appear one after another instead of stacked.
