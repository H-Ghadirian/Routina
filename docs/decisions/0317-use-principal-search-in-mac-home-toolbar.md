...
- Filter, mode, and Add controls remain available without crowding the search field; [0333](superseded/0333-move-mac-focus-control-to-planner-calendar-header.md) moves Focus to the Planner Calendar header.
