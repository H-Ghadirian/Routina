...
Mac Home uses a 1280 x 760 default window size and a 1200 x 720 minimum window size. The SwiftUI root content and the AppKit home-window configuration both enforce the same minimum so normal launches and fallback window presentation agree.
