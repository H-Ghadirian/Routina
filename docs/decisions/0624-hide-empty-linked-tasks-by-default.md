...
resolved relationships. Add More Details keeps `Linked Task` as the deliberate
entry point for starting a relationship. Once a relationship resolves, the
Linked Tasks section appears with its existing relationship controls.
...
- People can still create or link a relationship from Add More Details.
