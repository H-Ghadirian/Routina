...
extension HomeTCAView {
    ...
    func openDayPlanCalendarListTaskDetails(
        ...
        openMacTaskDetails(
            ...
            plannerDoneSelection: doneSelection
        )
    }
    ...
    func openMacTaskDetails(
        ...
        plannerDoneSelection: MacPlannerDoneTaskDetailSelection? = nil
    ) {
        plannerTaskDetailDoneSelection = plannerDoneSelection
        isEventEditorPresented = false
        isEmotionLogEditorPresented = false
        isNoteEditorPresented = false
        selectedNoteID = nil
    ...
    var macFiltersDetailContent: some View {
        HomeMacRoutineFiltersDetailView(
            ...
            selectedThinkingNeededFilter: homeFilterBindings.selectedThinkingNeededFilter,
