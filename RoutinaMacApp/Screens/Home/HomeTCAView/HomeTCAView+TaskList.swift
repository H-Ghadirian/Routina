...
extension HomeTCAView {
    ...
    private func taskListGroupHeaderTintOpacity(
        ...
        case .untagged:
            return 0.06
        case .plannedToday, .plannedTomorrow, .daily, .future, .regular, .deadlineDate, .pinned, .away, .archived:
            return 0.07
        }
    }
    ...
    private func taskListSectionIsExpanded(
        ...
        switch section.kind {
        case .plannedToday, .plannedTomorrow:
...
private extension HomeTaskListPresentationSection where Display == HomeFeature.RoutineDisplay {
    var canStartFocusTimer: Bool {
        ...
        switch kind {
        case .plannedToday, .plannedTomorrow, .daily, .future, .tag, .untagged, .regular, .deadlineDate, .pinned:
            return true
        case .away, .archived:
            return false
        }
